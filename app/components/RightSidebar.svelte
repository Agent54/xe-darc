<script>
	let { title, padding = true, onClose, children, openSidebars = new Set(), switchToResources, switchToSettings, switchToUserMods, switchToActivity, switchToAgent, switchToDevTools, devModeEnabled = false, headerControls = null } = $props()
</script>
