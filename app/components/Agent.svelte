...
<iframe style="background-color: #000; width: 0px; visibility: hidden; height: 0px;" title="voice-agent" src={agentIframeUrl} allow="microphone; clipboard-read; clipboard-write; screen-wake-lock 'self'"></iframe>
